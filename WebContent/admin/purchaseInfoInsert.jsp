...
<body>
	...
	<form action="/MediaManagerFinal/admin/purchaseInfoAdmin" method="get">
		<table border="1">
			...
			<tr>
				<th>purchaseID</th>
				<td><input type="text" id="purchaseID" name="purchaseID" readonly="true" /></td>
			</tr>
			<tr>

				<th>purchaseLocation</th>
				<td><input type="text" id="purchaseLocation" name="purchaseLocation" /></td>
			</tr>
		</table>

		<input type="hidden" name="action" value="insertPurchaseInfo">
		<button type="submit">Insert Purchase Info</button>
	</form>
