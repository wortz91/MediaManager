...
<body>
	<form action="/MediaManagerFinal/admin/genreItemAdmin"  method="get">
		...
		<input type="text" name="genreItemName">
		<input type="hidden" name="action" value="getAllGenres">
		<input type="submit" name="btnSubmit">
	</form>
	<a href="/MediaManagerFinal/admin/genreItemDetailInsert.jsp">Insert New Genre</a>
