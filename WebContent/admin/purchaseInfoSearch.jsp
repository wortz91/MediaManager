...
<body>
	<form action="/MediaManagerFinal/admin/purchaseInfoAdmin"  method="get">
		Purchase Info(leave blank and search to see entire Database):<br>
		<input type="text" name="purchaseInfoItemName">
		<input type="hidden" name="action" value="getAllPurchaseInfo">
		<input type="submit" name="btnSubmit">
	</form>
	<a href="/MediaManagerFinal/admin/purchaseInfoInsert.jsp">Insert New Purchase</a>
