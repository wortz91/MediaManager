...
@WebServlet(name="mediaType", urlPatterns = {"/mediaType"})
public class MediaTypeServlet extends HttpServlet {
    ...
    public void getItemCounts(HttpServletRequest request,
        ...
        session.setAttribute("itemCountList", mdAO.returnMediaTypeItemsCount());

        RequestDispatcher rd =
                request.getRequestDispatcher("/mediaTypeListDisplay.jsp");
