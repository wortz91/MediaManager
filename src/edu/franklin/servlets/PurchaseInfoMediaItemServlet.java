...
@WebServlet(name="purchaseInfoMediaItem", urlPatterns = {"/purchaseInfoMediaItem"})
public class PurchaseInfoMediaItemServlet extends HttpServlet {
    ...
    public void getPurchaseInfo(HttpServletRequest request,
        ...
        session.setAttribute("mediaPurchaseItemList", mdAO.returnPurchaseInfoMediaItemsCount());

        RequestDispatcher rd =
                request.getRequestDispatcher("/mediaPurchaseItemListDisplay.jsp");
